...
To create a Sign Language detection model which will detect the position of human hands and then convey the message on the viewfinder of camera in real time what the particular hand position means.
...
To show on the optical viewfinder of the camera module what a particular position of hand means with respect to Sign Language.
...
In this project our model is trying to detect a person’s hand position and then showing it on viewfinder, live as to what the hand position means as we have specified in Roboflow.

This model tries to solve the problem of people who are dumb and deaf and who wants to convey what they are saying to others using Sign Language but can’t as others haven’t learned Sign Language.

The model is efficient and highly accurate and hence works without any lag and also if the data is downloaded can be made to work offline.

REFERENCE

Roboflow:- https://roboflow.com/

Datasets or images used :- https://www.shutterstock.com/search/sign+language
...
https://blog.ai-media.tv/blog/7-reasons-sign-language-is-awesome
